-- 文件: actionWorst/AiWorstFarmerLeftFollowData.lua · 反编译 AI 模块（阅读用）

local AiWorstFarmerLeftFollowData = class("AiWorstFarmerLeftFollowData", AiFarmerLeftFollowData)

-- 最弱AI·上家农民跟牌 · 构造函数
function AiWorstFarmerLeftFollowData:ctor(params)
  AiWorstFarmerLeftFollowData.super.ctor(self, params)
end

-- 最弱AI·上家农民跟牌 · 出牌主入口：按局面分支决策并返回 AiSuitData（上家农民跟牌）
function AiWorstFarmerLeftFollowData:getActionSuitData()
  self.log("=上家农民跟牌")
...
return AiWorstFarmerLeftFollowData
